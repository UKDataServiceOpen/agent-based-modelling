...
@#$#@#$#@
<experiments>
  <experiment name="Wide sweep" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>[speed] of sample-car</metric>
    ...
    <steppedValueSet variable="number-of-cars" first="1" step="10" last="41"/>
  ...
  <experiment name="Narrow sweep" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>[speed] of sample-car</metric>
    ...
    <steppedValueSet variable="number-of-cars" first="15" step="5" last="30"/>
    <enumeratedValueSet variable="deceleration">
      <value value="0.005"/>
      <value value="0.006"/>
      <value value="0.007"/>
  ...
  <experiment name="Experiments" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>[speed] of sample-car</metric>
    ...
    <steppedValueSet variable="number-of-cars" first="18" step="3" last="30"/>
    <enumeratedValueSet variable="deceleration">
      <value value="0.006"/>
      <value value="0.0065"/>
      <value value="0.007"/>
